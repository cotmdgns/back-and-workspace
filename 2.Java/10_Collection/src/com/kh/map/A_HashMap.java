...
public class A_HashMap {
	...
	public void method2() {
		...
		System.out.println("홈런볼 : "+map.get("홈런볼"));
		
		// 2. 후렌차파이의 맛 정보 출력
		System.out.println("후렌치파이 : "+map.get("후렌치파이"));
		System.out.println("후렌치파이 : "+map.get("후렌치파이").getFlavor());
		
		
		// 3. 모든 과자 칼로리 총합과 평균 출력
		//쌤이한거
		int sum = 0;
...
//		System.out.println(entrySet);
//		for(Entry<String,Snack> i : entrySet) {
//			sum += i.getValue().getCalorie();
//		}
//		System.out.println("칼로리 종합 : " + sum);
//		avg = sum / map.size();
//		System.out.println("칼로리 평균 : " + avg);
	}
