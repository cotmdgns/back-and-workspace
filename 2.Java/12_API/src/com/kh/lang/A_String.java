...
public class A_String {
	...
	public void method1() {
		...
		System.out.println("str3 == str3 : " + (str3 == str4)); //false
	...
	public void method2() {
		...
		System.out.println("4. indexOf : " + index3); // -1
		...
		System.out.println("9. valusOf : "+str10);
	 ...
	 * - 16개의 문자를 저장할 수 있는 버퍼가 미리 생성되고 문자가 저정됨에 따라 자동 증가
	...
	public void method3() {
		...
		// 1. append(Strin str) : StringBuilder
		//    기존 문자열 뒤에 문자열 추가
		sb.append("Java!");
	...
	public void method4() {
		...
		String str = "HTML,CSS,JaveScript,MySQL,Java,JDBC,Servlet,JSP,JQuery,MyBatis,Spring,React";
...
//		System.out.println(st.nextToken());
		...
		// countTokens : 꺼내지 않고 남아 있는 토큰의 수를 확인
