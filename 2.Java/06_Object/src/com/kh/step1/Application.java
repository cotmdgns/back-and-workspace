...
public class Application {
	 ...
	 * 객체 : 실제로 존재하는 것 
	 * 
	 * 객체 지향 프로그램(OOP, Objected-Oriented Programming)
	 * - 프로그램을 개발하는 기법으로 객체들을 만들고 이러한 객체들을 연결해서 프로그램 완성하는 기법
	 * - 객체 지향 프로그래밍 특성을 지원하는 연어로 객체 지향 프로그래밍 언어라고 한다.
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * - new 연산자를 사용해서 생성
		 * - new 연사자는 Heap 영역에 객체를 생성하고 객체의 주소값을 반환
		 * - 객체의 주소값을 참조 타입의 변수에 저장해서 객체 사용
		 * */
		// 객체 생성 = 메모리에 올린다 = 객체의 구성요서(field, method)가 다 올라간다
		Tv tv = new Tv();
		/*
		 * JVM > Heap > Field, Method 가 올라간다
		 * JVM > Stack 에 있는 변수에 주소값 할당
		 * */
		System.err.println("TV 상태 : " + tv.power); // TV가 꺼진 상태
		tv.power();
		System.err.println("TV 상태 : " + tv.power); // TV가 켜진 상태
