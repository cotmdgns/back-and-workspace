 ...
 *  - 일반적인 맴버(변수, 메서드) 포함 가능 (변수 + 메서드 + 추상 메서드)
 *  - 객체 새엉을 할 수 없지만 참조형 변수 타입으로는 사용 가능
 *  - 상속 괸계로 구성되어 있으면 다형성 적용 가능
 *  
...
public class Application {
	...
	public static void main(String[] args) {
		...
		//Sports s = new Sports(5); -> 추상 클래스 객체 생성X
