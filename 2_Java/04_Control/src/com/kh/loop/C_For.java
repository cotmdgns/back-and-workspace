...
public class C_For {
	 ...
	 * 			false이면 실행하지 앟고 반복문을 빠져나감;
	 * - 증감식 : 반복문에서 사용하는 변수의 값을 중감, 주로 증감 연산자 사용
	 * */
	...
	public void method6() {
		 ...
		 * 호추할 때마다 매번 다른 랜덤값을 얻어낼 수 있음
		 * */
		double random = Math.random()*10; //0.0 <= random < 1.0
	...
	public void method7() {
		 ...
		 * - String.toCharArray() : 모든 문자가 들어 있는 char[] 형식의 데이터 변환
		 * */
