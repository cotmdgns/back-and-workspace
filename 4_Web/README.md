...
- 웹에서 서버 기능를 수행하는 프로그램으로 HTML 문서나 JPG, PNG 같은 이미지를
  HTTP 프로토콜을 통해 웹 브라우저에 제공하는 서버
- 서버 내부의 이미 만들어져 있는 정적인 요소들을 화면에 제공하는 역활
- Apache : Apache Software Foundtion에서 만든 웹 서버로 HTTP 통신에 대한 여러라이브러리 제공

### 웹 애플리케이션 서버 (WAS , Web Application Server)

- 웹 서버가 할 수 없는 다양한 비즈니스 로직을 수행하고 동적인 페이지를 만들어 제공하는 서버
- 웹 애플리케이션 서버는 웹 서버와 컨테이너로 구성
- Tomcat : Apache Software Foundtion에서 Servlet과 JSP를 통한 동적인 웹 문서를 처리하기 위해 만든 웹 애플리케이션 서버
...
- 서블릿을 등록하고 매핑하는 방법은 web_xml 과 @annotation을 이용하는 방법이 있다.
...
<servlet-mapping>
    <servlet-name>서블릿 이름</servlet-name>
    <url-ppttarn>접근 URL 패턴</url-ppttarn>
</servlet-mapping>
```
